...
var map = {
	"./checkout/checkout.module": [
		...
		"checkout-checkout-module~index-index-module~product-product-module~user-user-module",
		"checkout-checkout-module~index-index-module~product-product-module"
	],
	"./index/index.module": [
		"./src/app/index/index.module.ts",
		"checkout-checkout-module~index-index-module~product-product-module~user-user-module",
		"checkout-checkout-module~index-index-module~product-product-module",
		"index-index-module~product-product-module",
		"index-index-module"
	],
...
/* harmony import */ var _shared_loader_spinner_loader_spinner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/loader-spinner/loader-spinner */ "./src/app/shared/loader-spinner/loader-spinner.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(authService, productService, spinnerService) {
        this.authService = authService;
        this.productService = productService;
        this.spinnerService = spinnerService;
    ...
    ProductListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"],
            ...
            _shared_loader_spinner_loader_spinner__WEBPACK_IMPORTED_MODULE_3__["LoaderSpinnerService"]])
...
var LoaderSpinnerService = /** @class */ (function () {
    ...
    function LoaderSpinnerService() {
        var _this = this;
        this.spinnerObservable = new rxjs__WEBPACK_IMPORTED_MODULE_0__["Observable"](function (observer) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getLoggedInUser = function () {
        ...
        if (user) {
            ...
            if (user != null) {
                ...
                loggedUser.isAdmin = user.email === "anupamryadav@gmail.com" ? true : false;
            }
        }
        else {
            this.userDetails = null;
    ...
    AuthService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [angularfire2_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], AuthService);
    return AuthService;
}());
...
var ProductService = /** @class */ (function () {
    function ProductService(db, authService, toastyService, toastyConfig) {
        this.db = db;
        this.authService = authService;
        this.toastyService = toastyService;
        this.toastyConfig = toastyConfig;
    ...
    */
    ...
    ProductService.prototype.calculateFavProductCounts = function () {
        var _this = this;
        var x = this.getUsersFavouriteProduct()
            .snapshotChanges()
            .subscribe(function (data) {
            _this.navbarFavProdCount = data.length;
        });
    };
    /*
    ...
    */
    ...
    ProductService.prototype.getUsersCartProducts = function () {
        var user = this.authService.getLoggedInUser();
        this.cartProducts = this.db.list("cartProducts", function (ref) {
            return ref.orderByChild("userId").equalTo(user.$key);
        });
    ...
    ProductService.prototype.removeCart = function (key) {
    ...
    ProductService.prototype.calculateCartProductCounts = function () {
        var _this = this;
        var x = this.getUsersCartProducts()
            .snapshotChanges()
            .subscribe(function (data) {
            _this.navbarCartCount = data.length;
        });
    };
...
/* harmony import */ var _components_no_access_no_access_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/no-access/no-access.component */ "./src/app/shared/components/no-access/no-access.component.ts");
/* harmony import */ var _components_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/page-not-found/page-not-found.component */ "./src/app/shared/components/page-not-found/page-not-found.component.ts");
...
/* harmony import */ var _pipes_filterByBrand_pipe__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./pipes/filterByBrand.pipe */ "./src/app/shared/pipes/filterByBrand.pipe.ts");
...
/* harmony import */ var _services_admin_gaurd__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./services/admin-gaurd */ "./src/app/shared/services/admin-gaurd.ts");
/* harmony import */ var _services_auth_gaurd__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/auth_gaurd */ "./src/app/shared/services/auth_gaurd.ts");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/auth.service */ "./src/app/shared/services/auth.service.ts");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./services/user.service */ "./src/app/shared/services/user.service.ts");
/* harmony import */ var _loader_spinner_loader_spinner__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./loader-spinner/loader-spinner */ "./src/app/shared/loader-spinner/loader-spinner.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    SharedModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_4__["AngularFireModule"].initializeApp(_environments_firebaseConfig__WEBPACK_IMPORTED_MODULE_16__["FireBaseConfig"]),
            ...
            declarations: [
                ...
                _pipes_filterByBrand_pipe__WEBPACK_IMPORTED_MODULE_17__["FilterByBrandPipe"],
                _components_no_access_no_access_component__WEBPACK_IMPORTED_MODULE_14__["NoAccessComponent"],
            ...
            providers: [
                ...
                _services_auth_gaurd__WEBPACK_IMPORTED_MODULE_20__["AuthGuard"],
                _services_admin_gaurd__WEBPACK_IMPORTED_MODULE_19__["AdminGaurd"],
                ...
                _loader_spinner_loader_spinner__WEBPACK_IMPORTED_MODULE_23__["LoaderSpinnerService"]
            ]
        })
    ], SharedModule);
    return SharedModule;
...
var FireBaseConfig = {
    apiKey: "AIzaSyBkES1o7q82qy2I8eaMHl24u4VZf3VAGSM",
    authDomain: "optical-hangar-88010.firebaseapp.com",
    databaseURL: "https://optical-hangar-88010.firebaseio.com",
    projectId: "optical-hangar-88010",
    storageBucket: "optical-hangar-88010.appspot.com",
    messagingSenderId: "851359413193"
};
...
module.exports = __webpack_require__(/*! E:\Project\Mumbai-Shopping\src\main.ts */"./src/main.ts");
